...
#### 12.5.2 协程的复苏
为什么内核线程调度切换起来成本就要更高？  
答：内核线程的调度成本主要来自于用户态与核心态之间的状态转换(<font color='red'>int 0x80</font>)，而这两种状态转换的开销主要来自于响应中断、保护和恢复执行现场的成本。  
...
![image](https://github.com/zuofengnihao/Stu_JVM/blob/master/image/readbook/22.jpg)  
...
![image](https://github.com/zuofengnihao/Stu_JVM/blob/master/image/readbook/23.jpg)  
...
![image](https://github.com/zuofengnihao/Stu_JVM/blob/master/image/readbook/24.jpg)  
